...
public class ManyToManyUnidirectionalTest {
	...
	private static final Logger LOGGER = Logger.getLogger(ManyToManyUnidirectionalTest.class.getName());
	...
	@Test
	public void test_many_to_many_bidirectional_2() throws Exception {
		...
		employee = project.getEmployees().get(0);
